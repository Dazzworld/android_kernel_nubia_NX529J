...
static struct pll_freq_tbl apcs_c1_pll_freq[] = {
	...
	F_APCS_PLL(1651200000, 79, 0x0, 0x1, 0x0, 0x0, 0x0),
	F_APCS_PLL(1820800000, 80, 0x0, 0x1, 0x0, 0x0, 0x0),
	F_APCS_PLL(2000000000, 86, 0x0, 0x1, 0x0, 0x0, 0x0),
};
...
static struct clk_freq_tbl ftbl_gcc_oxili_gfx3d_clk[] = {
	...
	F_SLEW( 650000000, 1000000000,	  gpll3,	1,	0,	0),
	F_SLEW( 70000000, 1100000000,	  gpll3,	1,	0,	0),
	F_END
};
...
static struct  rcg_clk gfx3d_clk_src = {
	...
	.c = {
		...
		VDD_DIG_FMAX_MAP5(LOWER, 240000000, LOW, 400000000,
				  NOMINAL, 465000000, NOM_PLUS, 650000000,
				  HIGH, 700000000),
